...
public class MemberManageController extends BaseController{
	...
	public String search(){
		...
		if (pageIndex <= 0) {
			...
			if(headInfo.getString("member_card_number")!=null&&!"".equals(headInfo.getString("member_card_number"))){
				map.put("memberCardNumber", headInfo.getString("member_card_number"));
			}
