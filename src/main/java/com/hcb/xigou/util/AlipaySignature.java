...
public class AlipaySignature {
	...
	public static String rsa256Sign(String content, String privateKey, String charset) throws AlipayApiException {
		...
		try {
			...
			return new String(Bases64.encodeBase64(signed));
		} catch (Exception e) {
	...
	public static PrivateKey getPrivateKeyFromPKCS8(String algorithm, InputStream ins) throws Exception {
		...
		encodedKey = Bases64.decodeBase64(encodedKey);
	...
	public static boolean rsa256CheckContent(String content, String sign, String publicKey, String charset)
		...
		try {
			...
			return signature.verify(Bases64.decodeBase64(sign.getBytes()));
		} catch (Exception e) {
	...
	public static String rsaEncrypt(String content, String publicKey, String charset) throws AlipayApiException {
		try {
			...
			byte[] encryptedData = Bases64.encodeBase64(out.toByteArray());
			out.close();
	...
	public static String rsaDecrypt(String content, String privateKey, String charset) throws AlipayApiException {
		try {
			...
			byte[] encryptedData = StringUtils.isEmpty(charset) ? Bases64.decodeBase64(content.getBytes())
					: Bases64.decodeBase64(content.getBytes(charset));
	...
	public static boolean doCheck(String content, String sign, String publicKey, String encode) {
		try {
			KeyFactory keyFactory = KeyFactory.getInstance(AlipayConstants.SIGN_TYPE_RSA);
			...
			System.out.println("=================" + Base64.decodeBase64(sign.getBytes()));
